<b>EN:</b> Write a program that implements the stack with an extended interface so that it additionally supports the max operation while still keeping the running time of all operations constant.  
