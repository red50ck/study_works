<b>EN:</b> Write a program that implements the search for the maximum in each window of size m of the given array of numbers A[1 ... n] so that the running time of the program algorithm is O(n).  
